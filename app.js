...
app.post("/",function(req,res){
  let query = req.body.cityName.toLowerCase();
  ...
  https.get(url,function(response){
    ...
    if( response.statusCode === 404 ){
      ...
      response.on("data",function(data){
        ...
        res.render('weather',{city : query,temperature : temp,explain : desc,image : imageURL, humidity : humi, wind : wind});
